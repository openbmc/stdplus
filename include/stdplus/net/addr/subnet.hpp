...
template <typename Addr, typename Pfx>
struct std::hash<stdplus::detail::Subnet46<Addr, Pfx>> : stdplus::detail::SubnetHash<stdplus::detail::Subnet46<Addr, Pfx>>
{
};

template <>
struct std::hash<stdplus::SubnetAny> : stdplus::detail::SubnetHash<stdplus::SubnetAny>
{
};
