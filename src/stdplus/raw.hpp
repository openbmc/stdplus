 ...
 *
 *  @param[in] c - The container holding the data
 *  @return True if the contents are trivially copyable
 */
template <typename Container>
constexpr bool trivialContainer(const Container& c)
{
...
T copyFrom(const Container& c)
{
    ...
    static_assert(detail::trivialContainer(c));
    T ret;
